...
#ifndef _MBED_HTTPS_TLS_SOCKET_PSK_H_
#define _MBED_HTTPS_TLS_SOCKET_PSK_H_
...
class TLSSocketPsk {
public:
    TLSSocketPsk(NetworkInterface* net_iface, const char* hostname, uint16_t port/*, const char* ssl_ca_pem*/) {
...
#endif // _MBED_HTTPS_TLS_SOCKET_PSK_H_
